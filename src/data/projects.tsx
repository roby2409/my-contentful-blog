...
export const projectWebs: ProjectType[] = [
  ...
  {
    name: '(NON DISCLOSURE AGREEMENT)',
    description: 'Application used by Office of the Attorney General of the Republic of Indonesia.',
    link: '#',
  },
  {
  ...
  },
  {
    ...
    description: 'Web Profile Using Laravel',
    link: 'https://rsbhayangkarapalembang.id/',
    img: '2.jpeg',
  },
  {
  ...
  {
    name: 'Aplikasi Cinta Jiwa',
    description: 'Web Application Using NextJS',
    link: 'http://cintajiwa.professorira.com/',
    img: '4.jpg',
  },
  {
    name: 'insecure Web Application',
    description: 'Web Application Using Laravel',
    link: 'https://insecure.professorira.com/',
    img: '5.jpg',
  },
  {
    name: 'Sumsel 24',
  ...
  {
    name: 'Web Profile Professor',
    description: 'Web Profile of Lecturer',
    link: '#',
    img: '7.jpg',
  },
  {
    name: 'Real proof',
    description: 'Web Application E-Learning',
    link: 'http://realproof.professorira.com/',
    img: '8.jpg',
  },
  {
    name: 'Mega Arjuna International School',
    description: 'Web Profile of School',
    link: '#',
    img: '9.jpg',
  },
  {
    name: 'Rain Creative',
    description: 'Web Profile of Software Development Service',
    link: '#',
    img: '10.jpg',
  },
  {
    name: 'Web Admin Donor Darah RSMH Muhammad Hoesin',
    description: 'Web Application Administrator Dashboard Using Laravel',
    link: '#',
    img: '11.jpg',
  },
  {
...
export const projectMobiles: ProjectType[] = [
  ...
  },
  {
    ...
    description: 'Aplikasi for detection gadget addictive using flutter',
    img: 'cesa',
    imgMobile: ['1.png', '2.png', '3.png', '4.png'],
  },
  {
    name: 'LMS (Learning management system)',
    description: 'Aplikasi absensi sekolah terintegrasi Smartfren using flutter',
    img: 'lms',
    imgMobile: ['1.png', '2.png', '3.png', '4.png'],
  },
  {
    name: 'Create Sdk swift private framework',
    description: 'this is liveness sdk, i created when worked this sdk used bank using swift',
    img: 'sdk',
    imgMobile: ['1.gif', '2.gif', '3.gif', '4.gif'],
  },
  {
    name: 'App order CCTV',
    description: 'this app for order cctv and connect with whatsapp using react native',
    img: 'cctv',
  ...
  },
  {
    ...
    description:
      "Application to test children's personality through drawing and questions using flutter",
    img: 'kancil',
    imgMobile: ['1.png', '2.png', '3.png', '4.png', '5.png', '6.png'],
  },
  {
    name: 'Aplikasi Pinjol',
    description: 'Application pinjol with feature direct whatsapp using react native',
    img: 'pinjol',
    imgMobile: ['1.jpeg', '2.jpeg', '3.jpeg', '4.jpeg'],
  },
];
