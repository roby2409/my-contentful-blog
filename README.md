# My personal website with contentful

This repository contains the source code for my personal website using contentful. The website is designed to showcase my portfolio, projects, and provide information about me.

the content of my personal website has 2 modes light mode and dark mode

- light mode

![The homepage of my personal website ](blog-light-view.jpg 'The homepage of my website portfolio')

- with dark mode

![The homepage of my personal website ](blog-dark-view.jpg 'The homepage of my website portfolio')
...
To implement my website you must have experience with contentful you can create account in this link https://www.contentful.com/

after that you can signup and choose select the template starter, i follow the structure graphql like that, so you can just take CONTENTFUL_SPACE_ID and ACCESS_TOKEN from the settings
...
The first steps of the codegen generate files that contain the GraphQL schema and matching TypeScript types. All these files are located in the `src/libs/graphql` folder.
They're generated to the `src/libs/__generated` folder and ought to be committed once altered/added to the repository.
...
My website can be deployed to your hosting provider of choice.
...
Once you have the my website profile, you can deployed on your hosting provider, you can update the Content preview URL in your space settings.
...
If you have a problem with this blog, post a message in our [Contentful Community Slack](https://www.contentful.com/slack/).
